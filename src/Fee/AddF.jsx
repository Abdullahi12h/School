...
function Fee() {
  ...
  const fetchFees = () => {
    axios
      .get("https://backendschool1.onrender.com/fee/read")
  ...
  const fetchStudents = () => {
    axios
      .get("https://backendschool1.onrender.com/read/student")
  ...
  const handleSubmit = () => {
    axios
      .post("https://backendschool1.onrender.com/fee/create", form)
      .then(() => {
        fetchFees();
  ...
  const handleDelete = (id) => {
    axios
      .delete(`https://backendschool1.onrender.com/fee/delete/${id}`)
      .then(() => fetchFees())
      .catch((err) => console.error(err));
  };
